...
parser.add_argument("data", metavar="DIR", default="E:/Dataset/FlowDataset/FlyingChairs_release/", help="path to dataset")
# D:\Projects\toranwenhao
parser.add_argument(
    "--dataset",
    metavar="DATASET",
    default="flying_chairs",
    # default="flying_chairs",KITTI_occ
...
parser.add_argument(
    "-b", "--batch-size", default=16, type=int, metavar="N", help="mini-batch size"  # 8 16
)
parser.add_argument(
    "--lr",
    "--learning-rate",
...
parser.add_argument(
    "--pretrained", default= r'D:\Projects\toranwenhao\FlowNetPytorch-master\flying_chairs\04-21-22-03\flownets,adam,300epochs,epochSize1000,b8,lr0.0001\model_best.pth.tar',
    dest="pretrained", help="path to pre-trained model"
)
parser.add_argument(
...
def main():
    ...
    train_set, test_set = datasets.__dict__[args.dataset](
        ...
        co_transform=co_transform,#co_transform,
    ...
    for i, (input, target) in enumerate(val_loader):
        ...
        if i < len(output_writers):  # log first output of first batches
            if epoch == args.start_epoch:
                ...
                output_writers[i].add_image(
                    "Inputs", (input[0, :].cpu()).clamp(0, 1), 0
                # "Inputs", (input[0, :3].cpu() + mean_values).clamp(0, 1), 0
                )
                # output_writers[i].add_image(
                #     "Inputs", (input[0, 3:].cpu()).clamp(0, 1), 1
