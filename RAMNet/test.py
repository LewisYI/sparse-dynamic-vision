...
if __name__ == '__main__':
    ...
    #  --path_to_model /data/storage/michelle/e2depth_checkpoints/EventScape/e2depth_si_grad_loss_statenet_skip_convlstm_baseline_ergb_every5rgbframes_LR0003_S5_100_scale1/model_best.pth.tar
    #  --output_path /data/storage/michelle/e2depth_evaluation/test
    #  --data_folder /data/storage/michelle/dataset_mathias_23_07/test/
    parser = argparse.ArgumentParser(
        description='Learning DVS Image Reconstruction')
    parser.add_argument('--path_to_model', type=str,
                        help='path to the model weights',
                        default=r'D:\Projects\event_camera\ramnet\RAM_Net\e2depth_checkpoints\final_tests\e2depth_si_grad_loss_statenet_skip_conv_convgru_every5rgbframes_imageevents4loss_LR0003_S5_100_scale1_clip80_regf3_2\model_best.pth.tar')
    ...
    parser.add_argument('--output_path', type=str,
                        ...
                        default='e2depth_evaluation/test')
    parser.add_argument('--data_folder', type=str,
                        help='path to folder of data to be tested',
                        default='data/EventScape/Town05_val')
