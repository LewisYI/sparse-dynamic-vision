...
def FLAGS():
    ...
    parser.add_argument("--target_dataset", default="D:/Projects/event_camera/ramnet/RAM_Net/e2depth_evaluation/test/ground_truth/npy/depth_events0", required=True)
    parser.add_argument("--predictions_dataset", default="D:/Projects/event_camera/ramnet/RAM_Net/e2depth_evaluation/test/npy/events0", required=True)
